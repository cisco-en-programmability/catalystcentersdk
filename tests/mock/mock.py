...
from tests.mock.server.v3_1_6_0 import MockServerRequestHandler_v3_1_6_0
from tests.mock.server.v3_2_3_0 import MockServerRequestHandler_v3_2_3_0
...
def start_mock_server(port, version):
    ...
    if version == "3.1.6.0":
        mockServerHandler = MockServerRequestHandler_v3_1_6_0

    if version == "3.2.3.0":
        mockServerHandler = MockServerRequestHandler_v3_2_3_0
